...
\section{Improving error messages with clojure.spec}
	...
	%\emcomment{did we explain what a hashmap is?}
	...
	failed, what the failing value was, and what the number of the argument was (if the function takes multiple 
	arguments). In addition, they can be easily parsed, as we mentioned earlier.
