...
\section{Background}
	...
	you can provide any number of arguments to the {\tt +} function like {\tt (+ 3 4 5 6)}
	or {\tt (+ 3 4 5 6 10 15)}.
	...
	name to a value, you cannot what the name is bound to. \emcomment{It's not just that you can't change the value, you cannot change
	...
	One huge benefit of using immutable variables is minimizing side effects, which means 
	...
	Thus, side effects are not a serious concern as in imperative programming languages. 
	...
	can potentially be computed later as needed. 
	...
	represent course - course number pairs. The key and value are separated by a space, and each key - value pair is 
	separated by a comma.
	\begin{verbatim}
	{:Algorithms "CSCI3501", :Data-Structures "CSCI2101"}
	\end{verbatim}
	In this example:
	\begin{itemize}
	\item The curly braces represent this is a hash map.
	\item {\tt :Algorithms} and {\tt :Data-Structures} are the keys.
	\item {\tt "CSCI3501"} and {\tt "CSCI2101"} are the values.
	\end{itemize}
