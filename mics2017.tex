...
(s/fdef clojure.core/min
	...
	and if all arguments are type of {\tt number}.
	...
	One serious issue is that function specs do not work for inline functions, which are the type of function 
	that is inserted by the complier when they get to be used.
	...
	What it does is simply applying the given function to each of the collection's element. 
...
\section{Conclusions and future work}\label{sec:conclusion}
	...
	There are still, however, many challenges to overcome before Clojure can be easily adopted 
	...
	and confusing. Whether it is possible to ``hide'' these  
